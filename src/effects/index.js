...
// 8. src/effects/GasCloudEffect.js
// 9. src/effects/AcidPuddleEffect.js
// 10. src/effects/index.js (this file)
...
if (IdleAnts.Managers && IdleAnts.Managers.EffectManager) {
    ...
    IdleAnts.Managers.EffectManager.registerEffects = function(manager) {
        ...
        manager.effectClasses['gasCloud'] = IdleAnts.Effects.GasCloudEffect;
        manager.effectClasses['acidPuddle'] = IdleAnts.Effects.AcidPuddleEffect;
        manager.effectClasses['rainbowTrail'] = IdleAnts.Effects.RainbowTrailEffect;
        manager.effectClasses['electricExplosion'] = IdleAnts.Effects.ElectricExplosionEffect;
    };
} 